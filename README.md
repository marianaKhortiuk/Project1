1. I changed the 'N' values to 'No' and any 'Y' values to 'Yes', so before testing, delete the last migration and then revert this migration to see the changes in the database.
